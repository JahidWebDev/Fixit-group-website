...
const DrFixit = () => {
  ...
  return (
    <section className="w-full bg-[#b71c1c] z-50">
      <Container>
              <header className="border-b border-[#b71c1c]/20">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-6 md:px-10 py-4 flex justify-between items-center">
          {/* Left: Logo */}
