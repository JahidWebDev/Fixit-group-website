 ...
 <section className="bg-[#f5f5f5] py-10 px-10 md:px-16">
      <div className="max-w-[1300px] mx-auto">
        ...
        <p className="text-[15px] md:text-[30px] text-[#222] leading-relaxed mb-5 text-justify">
          In 2024, our business entered a new phase when we officially registered
          with the Government of Bangladesh under the name{" "}
          <span className="font-bold">Dr. Fixit Limited</span>, completing all legal
          and business documentation along with{" "}
          <span className="font-bold">RJSC certification</span>. This significant
          milestone marked the beginning of a new era in{" "}
        ...
        <p className="text-[15px] md:text-[30px] text-[#222] leading-relaxed text-justify">
          We quickly gained the trust of our customers, and within a short period,{" "}
          <span className="font-bold">Dr. Fixit Limited</span> established itself as
          a trusted and reliable name in Bangladesh’s{" "}
          <span className="font-bold">Construction Chemical Industry</span>. We
          offer a wide range of products including{" "}
          <span className="font-bold">
            Concrete Admixture, Waterproofing Solutions for Leak-free Homes, Damp
            Proofing, Damp Guard, Heat Proofing, and Wall Crack Solutions
          </span>
          , which have become a symbol of quality and reliability for our clients.
          Today, <span className="font-bold">Dr. Fixit Limited</span> maintains a
          leading position in the construction industry in Bangladesh, and every
          product and service we provide ensures customer trust and satisfaction.
        </p>
      </div>
    </section>
    ...
    {filteredProducts.map((p) => (
      ...
      >
        <div className="flex justify-center items-center h-[220px] p-4">
          <img src={p.img} alt={p.name} className="object-contain h-full w-auto" />
        </div>
        ...
        <div className="p-4 flex flex-col flex-grow">
          ...
          <p className="text-sm text-gray-600 text-center mb-4">{p.desc}</p>
        </div>
  ...
  <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-start justify-between gap-10">
    ...
    <div className="flex-1">
      ...
      <p className="text-gray-700 mt-6 leading-relaxed">
        <span className="font-bold">Dr. Fixit Limited</span> is committed to
        building strong, trustworthy, and sustainable business relationships
        with each of its dealers.
      </p>

      <p className="text-gray-700 mt-4 leading-relaxed">
        Our sole objective is to work together to establish a new standard of
        quality, durability, and reliability in Bangladesh’s construction
        industry.
      </p>
