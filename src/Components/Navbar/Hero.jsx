  ...
  return (
    <section id="hero" className="relative">
      ...
      >
        ...
        <button
          onClick={prevSlide}
          className="hidden lg:block absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 
             text-white text-5xl sm:text-6xl lg:text-7xl z-20 hover:scale-110 transition"
        >
          &#8249;
        </button>
        <button
          onClick={nextSlide}
          className="hidden lg:block absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 
             text-white text-5xl sm:text-6xl lg:text-7xl z-20 hover:scale-110 transition"
        >
          &#8250;
        </button>
