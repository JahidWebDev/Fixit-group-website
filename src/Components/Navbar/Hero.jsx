  ...
  <>
    ...
    <div className="absolute top-[80px] right-4 left-4 z-50 bg-white text-black rounded-2xl shadow-xl overflow-hidden animate-fadeIn">
      <ul className="flex flex-col text-base font-medium py-4">
        ...
        {/* About Us */}
        <li>
          <Link to="/OurBusiness" className="block px-5 py-3 hover:bg-gray-100">
            ABOUT US
          </Link>
        </li>
        ...
        <li>
          ...
          {submenuOpen && (
            <ul className="pl-6 bg-gray-50">
              <li>
                <Link to="/drfixit" className="block px-4 py-2 hover:bg-gray-100">
                  Dr. Fixit Ltd.
                </Link>
              </li>
              <li>
        ...
        {/* Careers */}
        <li>
          <Link to="/careers" className="block px-5 py-3 hover:bg-gray-100">
            CAREERS
          </Link>
        </li>
