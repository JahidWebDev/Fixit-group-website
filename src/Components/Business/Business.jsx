...
const Business = () => {
  ...
  At <span className="font-semibold">Fixit Group</span>, we believe in building Link family - united by purpose, driven by passion, and connected through Link shared love for
